...
const SpecialOffer = () => {
  return (
   ...
   Offer
        ...
        <p className="mt-4 lg:max-w-lg info-text">Embark on a shopping journey that redefines your experience with unbeatable deals. From premiere selctions to incredible saving. we offer unparalleled value that sets up apart.</p>
